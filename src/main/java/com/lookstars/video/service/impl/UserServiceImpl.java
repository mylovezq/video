...
public class UserServiceImpl implements UserService {
    ...
    public User saveWeChatUser(String code) {
        String accessTokenUrl = String.format(WeChatConfig.getGetAccessToken(), weChatConfig.getAppId(), weChatConfig.getAppsecret(), code);
        ...
        String userInfoUrl = String.format(WeChatConfig.getGetUserInfo(), accessToken, openid);
